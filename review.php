...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Flowers-Website_Review</title>
            ...
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content rounded-0">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Tìm theo keywords</h5>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="#">
                                ...
                                <p class="text-secondary mb-0">Beautiful Flowers</p>
                            </a>
                        </div>
                        <div class="col-lg-6">
                ...
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            <h4 class="text-light mb-3">Tại Sao Khách Hàng Yêu Mến Chúng Tôi ?</h4>
                            <p class="mb-4">Khách hàng yêu thích sản phẩm hoa của chúng tôi vì chất lượng tốt, đa dạng về mẫu mã và luôn tươi mới, 
                                đem đến sự hài lòng và niềm vui cho người nhận. 🌸 🌺.</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Address: 140 Lê Trọng Tấn, Tây Thạnh , Tân Phú ,HCM City</p>
                            <p>Email: anhthu.thuhoa@gmail.com</p>
                            <p>Phone: (+84)0869343824</p>
