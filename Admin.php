...
<body>
                                ...
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative hoa-item">
                                                <div class="hoa-img">
                                                    <img src="img/rose-item-8.jpg" class="img-fluid w-100 rounded-top" alt="">
                                                </div>
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Rose</div>
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    <h4>Raspberries</h4>
                                ...
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative hoa-item">
                                                <div class="hoa-img">
                                                    <img src="img/hoa-item-7.jpg" class="img-fluid w-100 rounded-top" alt="">
                                                </div>
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Blue Rose</div>
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    <h4>Apple</h4>
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative hoa-item">
                                                <div class="hoa-img">
                                                    <img src="img/hoa-item-8.jpg" class="img-fluid w-100 rounded-top" alt="">
                                                </div>
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Blue Rose</div>
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    <h4>Apple</h4>
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative hoa-item">
                                                <div class="hoa-img">
                                                    <img src="img/hoa-item-15.jpg" class="img-fluid w-100 rounded-top" alt="">
                                                </div>
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Blue Rose</div>
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    <h4>Apple</h4>
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative hoa-item">
                                                <div class="hoa-img">
                                                    <img src="img/hoa-item-16.jpg" class="img-fluid w-100 rounded-top" alt="">
                                                </div>
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Blue Rose</div>
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    <h4>Apple</h4>
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative hoa-item">
                                                <div class="hoa-img">
                                                    <img src="img/hoa-item-17.jpg" class="img-fluid w-100 rounded-top" alt="">
                                                </div>
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Blue Rose</div>
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    <h4>Apple</h4>
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative hoa-item">
                                                <div class="hoa-img">
                                                    <img src="img/hoa-item-18.jpg" class="img-fluid w-100 rounded-top" alt="">
                                                </div>
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Blue Rose</div>
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    <h4>Apple</h4>
                                ...
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative hoa-item">
                                                <div class="hoa-img">
                                                    <img src="img/hoa-item-10.jpg" class="img-fluid w-100 rounded-top" alt="">
                                                </div>
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Grandiflora</div>
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    <h4>Apricots</h4>
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative hoa-item">
                                                <div class="hoa-img">
                                                    <img src="img/hoa-item-11.jpg" class="img-fluid w-100 rounded-top" alt="">
                                                </div>
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Grandiflora</div>
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    <h4>Apricots</h4>
                                ...
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative hoa-item">
                                                <div class="hoa-img">
                                                    <img src="img/hoa-item-14.jpg" class="img-fluid w-100 rounded-top" alt="">
                                                </div>
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Antique</div>
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    <h4>Oranges</h4>
        ...
        <div class="container-fluid hoa py-5">
            <div class="container py-5">
                <h1 class="mb-0">"Blossoms Without Boundaries" 🌺🌼🌻</h1>
                ...
                <div class="row g-4 align-items-center">
                    <div class="col-lg-6">
                        <div class="py-4">
                            ...
                            <p class="fw-normal display-3 text-dark mb-4">Của Cửa Hàng</p>
                    ...
                    <div class="row g-4">
                       ...
                       <!-- <div class="col-md-6 col-lg-6 col-xl-3">
                            <div class="text-center">
                                <img src="img/hoa-item-1.jpg" class="img-fluid rounded fixed-size" alt="">
                                <div class="py-4">
        ...
        <div class="container-fluid review py-5">
            <div class="container py-5">
                <div class="review-header text-center">
                    ...
                    <h1 class="display-5 mb-5 text-dark">Review Customer</h1>
                </div>
